...
def create_confusion_matrix(data):
    ...
    ax = sns.heatmap(confusion_matrix_df_percent, annot=True, fmt='.1f', cmap='Blues',
                    ...
                    vmin=0, vmax=max_value, cbar_kws={'shrink': 0.8},annot_kws={'size': 18})  # Control the size of the color bar
    ...
    plt.savefig('DEFENSE_SCRIPTS/multimodal_baseline_cross_entropy.png', dpi=300, bbox_inches='tight')
    plt.show()
    # Save figure as png
