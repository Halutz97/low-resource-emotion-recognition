...
from audio_model import AudioClassifier, load_local_model
...
def process_audio(audio_file, audio_model, audio_task):
    ...
    elif audio_task == "regressor":
        out_prob = audio_model.predict_file(audio_file)
        score = None
        index = None
        text_lab = None
...
def process_video(video_file, backbone_model_path, LSTM_model_path, video_model):

    out_prob, score, index, text_lab = video_model.classify_video_file(video_file, backbone_model_path, LSTM_model_path)
...
if __name__ == '__main__':
    ...
    audio_task = "regressor" # Change this to the model you are using
    ...
    audio_folder = r"C:\Users\DANIEL\Desktop\thesis\CREMA-D\AudioWAV_testing"
    ...
    video_folder = r"C:\Users\DANIEL\Desktop\thesis\CREMA-D\VideoMP4_testing"
    ...
    labels_data = pd.read_csv(r"C:\Users\DANIEL\Desktop\thesis\CREMA-D\voted_combined_labels_corrected_testing.csv")
    ...
    if audio_task == "classifier":
        ...
        audio_model = load_local_model(model_dir, hparams_file)
